                ...
                <StyledMediaContainer>
                    ...
                    <StyledFormatContainer>
                        ...
                        <StyledOptionsContainer>
                            ...
                            <StyledOptionsButton className='hover-red' onMouseEnter={() => updateExportIconSrc(ExportIconWhite)} onMouseLeave={() => updateExportIconSrc(ExportIcon)} >
                                <StyledOptionsButtonIcon className='options-icon' src={exportIconSrc} />
                                <StyledOptionsButtonText>Export</StyledOptionsButtonText>
                            </StyledOptionsButton>
                            <StyledOptionsButton className='hover-red' onMouseEnter={() => updateShareIconSrc(ShareIconWhite)} onMouseLeave={() => updateShareIconSrc(ShareIcon)} >
                                <StyledOptionsButtonIcon className='options-icon' src={shareIconSrc} />
