    ...
    <StyledHeader className="header-demo">
      <StyledLeftPart>
        ...
        <StyledElementContainer>
          <StyledSubtitle
            target="_blank"
            href="https://sparta.cz/cs/zapasy/kalendar/a-tym/2023-2024"
          >
            GAMES
          </StyledSubtitle>
          <StyledSubtitle target="_blank" href="https://sparta.cz/cs/tym/a-tym">
            TEAMS
          </StyledSubtitle>
          <StyledSubtitle target="_blank" href="https://sparta.cz/cs/">
            SPORT
          </StyledSubtitle>
          <StyledSubtitle target="_blank" href="https://sparta.cz/cs/fanzona/">
            COMMUNITY
          </StyledSubtitle>
        </StyledElementContainer>
      </StyledLeftPart>
